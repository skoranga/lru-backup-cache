...
// resize the caches when the max changes.
Object.defineProperty(Cache.prototype, 'max', {
  set: function (max) {
      console.log('HIT', this._cache.max);
      this._cache.max = max;
      this._backupCache.max = max * 2;
      console.log('HIT', this._cache.max);
  },
  get: function () {
...
// update the maxAge for any future items that are set
// does NOT affect existing items
Object.defineProperty(Cache.prototype, 'maxAge', {
  set: function (maxAge) {
    this._cache.maxAge = maxAge;
    this._backupCache.maxAge = maxAge * 4;
  },
  get: function () {
    return this._cache.maxAge;
  },
  enumerable: true
});
